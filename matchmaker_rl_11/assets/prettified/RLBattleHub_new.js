...
E as yt,
F as Nt}
from"./index-BCsonH-C.js";
import{
a as wt,
T as kt}
from"./TeamLeaderboard-C4GHvkgG.js";
import{
T as St}
...
t&&(m(!0),
He(t.competition_id,
t.slot_index).then(d=>S(d.stats)).catch(()=>S(null)).finally(()=>m(!1)))}
,
[t]);
const i=()=>{
X.playClick(),
...
w(!1)}
,
g=d=>new Date(d).toLocaleDateString("zh-TW",
{
year:"numeric",
month:"short",
day:"numeric"}
...
children:c("rl.slot.empty_title",
{
index:u}
)}
),
...
children:[e.jsx("span",
{
children:c("rl.slot.sandbox_limits")}
),
e.jsxs("span",
{
children:["📦 ",
c("rl.slot.limit_memory",
{
value:v.memory_mb}
)]}
),
...
children:c(R?"rl.slot.packages_collapse":"rl.slot.packages_expand")}
),
R&&e.jsx("div",
{
className:"mt-1 flex flex-wrap gap-1",
children:b.length===0?e.jsx("span",
{
className:"font-epic text-[9px] text-stone-600",
children:c("rl.slot.packages_custom_image")}
):b.map(d=>e.jsx("span",
{
...
children:c("rl.slot.active_slot",
{
index:u}
)}
),
...
title:c("rl.slot.auto_battle_active",
{
defaultValue:"指定自動出戰"}
),
children:"⚡ 自動"}
...
):k&&k.length>0?e.jsxs(e.Fragment,
{
children:[e.jsx(Ct,
{
stats:k}
...
children:c("rl.slot.view_agent_stats",
{
defaultValue:"詳細分析"}
)}
)]}
...
children:c("rl.slot.no_battles_yet",
{
defaultValue:"尚無對戰紀錄"}
)}
)]}
...
children:c("rl.slot.weights",
{
name:j(t.weights_filename)}
)}
),
e.jsx("p",
{
className:"font-mono text-[9px] text-[#5c3c1e]/75",
children:c("rl.slot.uploaded_at",
{
date:g(t.created_at)}
)}
)]}
...
X.playClick()}
,
title:t.is_auto_battle?c("rl.slot.auto_battle_unset",
{
defaultValue:"取消指定，改為隨機挑選"}
):c("rl.slot.auto_battle_set",
{
...
`,
children:t.is_auto_battle?c("rl.slot.auto_battle_active_btn",
{
defaultValue:"⚡ 自動出戰中 · 點擊取消"}
):c("rl.slot.auto_battle_set_btn",
{
defaultValue:"設為自動出戰"}
)}
),
...
children:c("rl.slot.confirm_delete")}
),
e.jsx("button",
{
onClick:o,
...
,
$e="w-full bg-black/40 border border-gray-700 text-rpg-paper px-3 py-2 font-pixel text-sm focus:outline-none focus:border-rpg-gold";
function O(t){
return t<1024*1024?`${
(t/1024).toFixed(0)}
 KB`:`${
...
"stable-baselines3",
"sb3-contrib"];
j.includes("pacman")?N=["gymnasium[atari]",
"ale-py",
"autorom[accept-rom-license]",
"stable-baselines3[extra]",
"shimmy[atari]>=0.2.1"]:j.includes("texas")||j.includes("holdem")||j.includes("poker")?N=["pettingzoo",
"rlcard",
"pygame",
"stable-baselines3",
"sb3-contrib"]:j.includes("chess")?N=["pettingzoo",
"chess",
"pygame",
"stable-baselines3",
"sb3-contrib"]:N=["gymnasium",
"stable-baselines3"];
const f=`name: ${
d}
...
M?"bg-emerald-950/80 border border-emerald-500/50 text-emerald-400 font-bold shadow-[0_0_8px_rgba(16,
185,
129,
...
e.jsx("span",
{
children:a(M?"rl.guide.copied":"rl.guide.copy")}
)]}
)}
,
[T,
...
P=r!==null,
G=(m?.size??0)>dt,
ae=L?H!==null?a("rl.upload.uploading_weights",
{
progress:H.percent}
):a("rl.upload.uploading"):a(P?"rl.upload.save_changes":"rl.upload.submit"),
le=async C=>{
if(C.preventDefault(),
V(null),
!v.trim()){
V(a("rl.upload.error_name"));
return}
if(!P&&!w){
V(a("rl.upload.error_agent_required"));
return}
i(!0);
try{
...
M.append("name",
v.trim()),
c.trim()&&M.append("description",
c.trim()),
w&&M.append("agent_file",
w),
S&&M.append("model_file",
S);
const ee=I=>I<=0?"計算速度中...":I<1024?`${
I.toFixed(0)}
 B/s`:I<1024*1024?`${
(I/1024).toFixed(1)}
 KB/s`:`${
(I/(1024*1024)).toFixed(1)}
 MB/s`;
if(m&&G){
z({
percent:0,
...
percent:D.percent,
speed:ee(D.speed),
loaded:O(D.loadedBytes),
total:O(D.totalBytes)}
)}
);
M.append("weights_upload_id",
I);
const te=await Ee(t,
M);
F(te)}
else{
m&&M.append("weights_file",
m);
const I=(w?.size??0)+(S?.size??0)+(m?.size??0)+1024;
z({
percent:0,
speed:"0 KB/s",
loaded:"0 MB",
...
children:P?a("rl.upload.title_edit",
{
index:u}
...
type:"file",
accept:".py",
onChange:C=>k(C.target.files?.[0]??null),
...
type:"file",
accept:".py",
onChange:C=>p(C.target.files?.[0]??null),
className:"font-pixel text-xs text-gray-400 file:mr-3 file:py-1.5 file:px-3 file:border file:border-gray-600 file:bg-black/40 file:text-rpg-gold file:font-pixel file:text-xs file:cursor-pointer hover:file:border-rpg-gold focus:outline-none",
disabled:L}
),
S&&e.jsx("p",
...
.pt,
.joblib",
onChange:C=>R(C.target.files?.[0]??null),
className:"font-pixel text-xs text-gray-400 file:mr-3 file:py-1.5 file:px-3 file:border file:border-gray-600 file:bg-black/40 file:text-rpg-gold file:font-pixel file:text-xs file:cursor-pointer hover:file:border-rpg-gold focus:outline-none",
disabled:L}
),
m&&e.jsxs("p",
...
P&&r.weights_filename&&!m&&e.jsx("p",
{
...
children:u("rl.result.status.pending")}
);
...
children:u("rl.result.status.running")}
);
...
children:u("rl.result.status.completed")}
);
...
children:u("rl.result.status.failed")}
);
default:return null}
}
,
...
=Q(),
_=Ae(),
a=t.participants.find(p=>p.user_id===u)??null,
[v,
b]=l.useState(!!a?.is_pinned),
[c,
h]=l.useState(!1);
l.useEffect(()=>{
b(!!a?.is_pinned)}
...
h(!0);
try{
const m=v?await pt(t.id):await mt(t.id);
b(m.is_pinned),
r?.(t.id,
m.is_pinned)}
catch(m){
alert(fe(m,
n("rl.result.pinned_failed")))}
finally{
h(!1)}
}
}
...
S=new Date(t.created_at).toLocaleDateString(F.language,
{
year:"numeric",
month:"short",
day:"numeric"}
...
{
className:"flex items-center gap-2",
children:[t.status==="completed"&&a&&e.jsx("button",
{
onClick:w,
disabled:c,
className:`shrink-0 flex items-center justify-center w-5 h-5 border rounded-[2px] transition-colors ${
v?"border-amber-600 bg-amber-600/10 text-amber-700":"border-[#78350F]/30 text-[#78350F]/50 hover:text-amber-600 hover:border-amber-600"}
 disabled:opacity-40 cursor-pointer`,
title:n("rl.result.pin_highlight"),
children:e.jsx("svg",
{
...
children:n("rl.lobby.waiting")}
):t.participants.map(p=>{
const m=p.user_id===u;
return e.jsxs("div",
{
className:`flex items-center justify-between gap-2 ${
m?"text-amber-800 font-bold":"text-[#2B2017]/85"}
`,
children:[e.jsxs("div",
{
...
children:n("rl.lobby.self")}
),
e.jsx("span",
{
className:"font-parchment text-sm truncate",
children:p.slot_name??`Agent #${
p.rl_slot_id}
`}
)]}
),
...
children:[p.final_score!==null&&e.jsx("span",
{
className:"font-mono text-xs font-bold text-[#2B2017]",
title:n("rl.result.score",
{
defaultValue:"得分"}
),
children:p.final_score.toLocaleString(void 0,
{
maximumFractionDigits:1}
)}
),
p.elo_delta!==null&&e.jsxs("span",
{
className:`font-mono text-[10px] font-bold ${
p.elo_delta>=0?"text-emerald-700":"text-rose-800"}
`,
children:[p.elo_delta>=0?"(▲ +":"(▼ ",
Math.abs(p.elo_delta).toFixed(1),
")"]}
)]}
)]}
,
...
e.jsx("span",
{
children:n("rl.index.players_count",
{
count:t.max_players}
)}
)]}
...
const c=t[0],
h=t[t.length-1];
n.strokeStyle=h>=c?"#10b981":"#ef4444",
t.forEach((S,
p)=>{
const m=p/(t.length-1)*(F-4)+2,
R=_-(S-a)/b*(_-6)-3;
p===0?n.moveTo(m,
R):n.lineTo(m,
R)}
...
y=N.top-f.top,
B=N.left-f.left;
(B!==0||y!==0)&&(j.style.transform=`translate(${
B}
px,
 ${
y}
...
requestAnimationFrame(()=>{
j.style.transform="",
j.style.transition="transform 0.5s cubic-bezier(0.2,
 0.8,
 0.2,
 1),
 border-color 0.15s,
...
[m,
R]=l.useState(null),
[L]=l.useState(()=>localStorage.getItem("rl_particles")!=="false");
if(l.useEffect(()=>{
let o=!1;
return p(!0),
R(null),
...
o||R(g instanceof Error?g.message:r("rl.lobby.error_load"))}
).finally(()=>{
o||p(!1)}
),
ut(t).then(g=>{
...
;
g.forEach(d=>{
d.history&&d.history.length>0&&(j[d.user_id]=d.history.map(N=>N.value))}
),
b(j)}
}
).catch(g=>console.error("[EloLeaderboard] ELO history load failed:",
g)),
u||bt(t).then(g=>{
o||h(g)}
).catch(g=>console.error("[EloLeaderboard] H2H matrix load failed:",
g)),
()=>{
o=!0}
}
...
if(n.length===0)return e.jsx("div",
{
...
children:[n.length>0&&(L?e.jsxs("div",
{
...
children:u?i[1].best_score?.toFixed(1):Math.round(i[1].elo_rating)}
)]}
),
i[0]&&e.jsxs("div",
{
...
children:u?i[0].best_score?.toFixed(1):Math.round(i[0].elo_rating)}
)]}
),
i[2]&&e.jsxs("div",
{
...
children:i[2].nickname??i[2].username}
),
e.jsx("span",
{
className:"font-parchment text-[10px] text-stone-500 block truncate font-bold w-full",
children:i[2].slot_name}
),
e.jsx("div",
{
className:"scale-80 my-0.5",
...
children:u?i[2].best_score?.toFixed(1):Math.round(i[2].elo_rating)}
)]}
)]}
)]}
):e.jsxs("div",
...
!u&&c&&c.players.length>0&&e.jsxs("div",
{
...
(j*100).toFixed(0)}
%`,
B=j>=.5?"text-emerald-100":"text-rose-100",
T=`${
o.nickname||o.username}
 對陣 ${
...
style:{
backgroundColor:f?"transparent":y}
,
title:T,
children:[e.jsx("span",
{
...
children:r(u?"rl.lobby.best_score":"rl.lobby.elo")}
),
!u&&e.jsx("span",
{
...
ref:_,
className:"flex flex-col gap-1.5",
children:n.slice(3).map((o,
g)=>{
const j=g+4,
d="text-stone-400",
N=o.nickname??o.username;
return e.jsxs("div",
{
"data-flip-id":o.user_id,
...
j===1?"border-amber-500 shadow-[0_0_8px_rgba(217,
119,
6,
...
children:o.slot_name}
)]}
),
v[o.user_id]&&v[o.user_id].length>=2&&e.jsx("div",
{
...
d}
`,
children:u?o.best_score!=null?o.best_score.toFixed(1):"—":Math.round(o.elo_rating)}
),
!u&&e.jsx("span",
{
...
k(null),
Pe(t).then(y=>{
f||b(y.filter(B=>B.user_id!==n))}
).catch(y=>{
f||k(y instanceof Error?y.message:a("rl.challenge.error_load"))}
).finally(()=>{
f||h(!1)}
),
()=>{
...
p(y=>{
const B=new Set(y);
return B.has(f)?B.delete(f):B.size<o&&B.add(f),
B}
)}
,
j=async()=>{
...
children:S.size>0?a("rl.challenge.subtitle_selected",
{
count:o,
selected:S.size,
total:o}
...
const y=S.has(f.user_id),
B=!y&&S.size>=o,
E=f.nickname??f.username;
return e.jsxs("button",
{
type:"button",
disabled:B||m,
...
y?"border-rpg-gold bg-rpg-gold/10":B?"border-gray-700 bg-black/20 opacity-40 cursor-not-allowed":"border-gray-700 bg-black/20 hover:border-gray-500"].join(" "),
children:[e.jsx("div",
{
...
onClick:j,
className:"flex-1 bg-black/40 border border-rpg-gold text-rpg-gold font-pixel text-xs py-2 px-4 hover:bg-black/60 disabled:opacity-50 disabled:cursor-not-allowed transition-colors uppercase tracking-wider",
children:a(m?"rl.challenge.submitting":"rl.challenge.submit")}
),
e.jsx("button",
{
type:"button",
...
m++){
const R=_*p.speed,
L=Math.sin(m*.1+_*2)*Math.cos(m*.05-_)*4*w,
i=h+Math.sin(m*p.frequency+R)*k*p.amplitudeMultiplier+L;
m===0?n.moveTo(m,
i):n.lineTo(m,
i)}
n.stroke()}
...
h)try{
for(const x of s)await re.post("/users/me/guides",
{
guide_key:x,
value:!1}
)}
...
oe]=l.useState(0),
[ve,
Ue]=l.useState(()=>localStorage.getItem("rl_particles")!=="false"),
[ye,
Ne]=l.useState([]),
Oe=()=>{
Ue(s=>{
...
[]),
l.useEffect(()=>{
r&&(re.get("/tavern/competitions/active").then(s=>{
const x=s.data.find($=>$.id===r)??null;
c(x)}
).catch(s=>console.error("[RLBattleHub] competition fetch error:",
s)),
h?(re.get("/users/me").then(s=>S(s.data.id)).catch(s=>console.error("[RLBattleHub] user fetch error:",
s)),
L(!0),
gt(r).then(s=>m(s)).catch(s=>console.error("[RLBattleHub] slots fetch error:",
s)).finally(()=>L(!1)),
Be(r).then(s=>Y(s)).catch(()=>{
}
),
Fe(r).then(s=>y(s)).catch(()=>{
}
)):(S(0),
m([]),
L(!1),
...
20).then(s=>{
o(s),
E.current=s.length===20}
).catch(s=>console.error("[RLBattleHub] battles fetch error:",
s)).finally(()=>j(!1)))}
,
[r,
h]),
l.useEffect(()=>{
r&&re.get(`/tasks/competitions/${
r}
`).then(s=>Ne(s.data)).catch(()=>Ne([]))}
,
[r]);
const{
connect:me,
...
const s=ie;
s.type==="match-found"&&s.competition_id===r&&s.session_id&&(Y(null),
he.setState({
lastMessage:null}
),
n(`/rl/battles/${
...
n]),
l.useEffect(()=>{
h&&U?.in_queue&&me("/ws/notifications")}
,
[h,
U?.in_queue,
me]),
l.useEffect(()=>{
if(!r||!k||!U?.in_queue)return;
const s=setInterval(()=>{
Be(r).then(x=>{
Y(x),
x.status==="matched"&&x.matched_session_id&&(clearInterval(s),
Y(null),
he.setState({
lastMessage:null}
),
...
const x=await jt(r,
s.slot_index);
m($=>$.map(A=>A.slot_index===x.slot_index?x:{
...A,
is_auto_battle:!1}
))}
catch(x){
...
Ye=s=>{
m(x=>{
const $=x.findIndex(A=>A.slot_index===s.slot_index);
if($!==-1){
const A=[...x];
return A[$]=s,
A}
...
o(s),
E.current=s.length===20}
).catch(s=>console.error("[RLBattleHub] battles refresh error:",
s)).finally(()=>j(!1)),
h&&Fe(r).then(s=>y(s)).catch(()=>{
}
)}
,
ce=l.useCallback((s,
x)=>{
y($=>{
const A=$.some(Z=>Z.id===s);
if(x&&!A){
const Z=i.find(se=>se.id===s);
return Z?[{
...Z,
participants:Z.participants.map(se=>se.user_id===k?{
...se,
is_pinned:!0}
:se)}
,
...$]:$}
return x?$:$.filter(Z=>Z.id!==s)}
)}
,
[i,
k]),
...
...x]),
B.current=s),
E.current=x.length===20}
).catch(x=>console.error("[RLBattleHub] battles load-more error:",
x)).finally(()=>{
T.current=!1,
N(!1)}
)}
...
[r]);
l.useEffect(()=>{
if(!(z==="history"||z==="lobby"))return;
const x=z==="history"?V.current:H.current;
if(!x)return;
const $=new IntersectionObserver(A=>{
A[0].isIntersecting&&ke()}
,
{
rootMargin:"120px"}
);
...
,
et=b?.rl_max_slots??3,
tt=new Map(p.map(s=>[s.slot_index,
s])),
Se=new Set(f.map(s=>s.id)),
ue=i.filter(s=>s.participants.some(x=>x.user_id===k)),
st=ue.filter(s=>!Se.has(s.id)),
rt=i.filter(s=>!Se.has(s.id)),
at=p.length>0?p[0].player_tier??"UNRANKED":"UNRANKED",
lt=p.length>0?p[0].elo_rating:1e3,
nt=p.length>0?p[0].elo_games_played:0,
Ce=p.length>0?p[0].best_score:null;
return e.jsxs("div",
{
...
children:b?.name??t("rl.hub.title")}
),
e.jsx("p",
{
className:"font-parchment text-xs text-stone-500 mt-1 uppercase font-bold tracking-widest",
children:b?.competition_type==="rl_pvp"?t("rl.hub.type_pvp"):t("rl.hub.type_solo")}
)]}
),
e.jsxs("div",
{
...
children:t(ve?"rl.hub.disable_effects":"rl.hub.enable_effects")}
),
e.jsx("a",
{
href:`${
...
children:p.length>0?t("rl.slot.live_status",
{
defaultValue:"代理人配置中"}
...
children:p.length>0?t("rl.hub.challenger_desc",
{
...
children:[b?.competition_type==="rl_solo"?e.jsxs("div",
{
...
b?.competition_type!=="rl_solo"&&e.jsx("div",
{
...
children:Tt.map(s=>e.jsx("button",
{
onClick:()=>P(s.id),
...
z===s.id?"text-amber-500 bg-stone-900/60 border border-amber-600/50 sm:border-0 sm:border-b-2 sm:border-amber-600 sm:bg-transparent -mb-px font-bold":"text-stone-500 bg-stone-950/40 border border-stone-850 sm:border-0 sm:bg-transparent hover:text-stone-300"}
`,
...
onStatsClick:x=>I(x),
onSetAutoBattle:Ge,
sandboxLimits:b?.rl_memory_mb!=null&&b?.rl_timeout_seconds!=null?{
memory_mb:b.rl_memory_mb,
timeout_sec:b.rl_timeout_seconds}
:null,
sandboxPackages:b?.rl_sandbox_packages??null}
,
s))}
),
...
{
value:q??"",
onChange:s=>Ve(Number(s.target.value)),
...
b?.competition_type==="rl_pvp"?e.jsxs("div",
{
...
children:pe?"...":t("rl.hub.start_matchmaking")}
),
e.jsx("button",
{
onClick:()=>q&&D(!0),
...
children:t(ge?"rl.result.loading":"rl.hub.solo_challenge")}
)]}
),
e.jsxs("div",
{
...
children:t(g?"rl.result.loading":"rl.hub.refresh_battles")}
)]}
),
...
children:[e.jsxs("span",
{
className:"font-pixel text-[10px] text-amber-500/60 uppercase tracking-wider mb-2 block",
children:["📌 ",
t("rl.history.pinned",
"釘選精彩")]}
),
...
children:f.filter(s=>s.participants.some(x=>x.user_id===k)).map(s=>e.jsx(xe,
{
session:s,
currentUserId:k,
onPinChange:ce}
...
):ue.length===0&&f.length===0?e.jsx("p",
{
...
{
className:"font-pixel text-[10px] text-rpg-paper/30 animate-pulse uppercase tracking-wider",
children:t("common.loading")}
),
!d&&!E.current&&ue.length>0&&e.jsxs("span",
{
className:"font-pixel text-[10px] text-rpg-paper/20 uppercase tracking-wider",
children:["── ",
t("rl.history.end",
"已無更多紀錄"),
" ──"]}
...
{
competitionId:r,
isSolo:b?.competition_type==="rl_solo"}
),
G==="teams"&&e.jsx(kt,
{
competitionId:r}
...
children:t(g?"rl.result.loading":"rl.hub.refresh")}
)]}
),
f.length>0&&e.jsxs("div",
{
...
!d&&!E.current&&i.length>0&&e.jsxs("span",
{
className:"font-pixel text-[10px] text-rpg-paper/20 uppercase tracking-wider",
children:["── ",
t("rl.history.end",
...
(le!==null||C!==null)&&e.jsx(Bt,
{
competitionId:r,
slotIndex:le??C.slot_index,
existingSlot:C,
envName:b?.rl_env_name??"",
onSuccess:Ye,
onCancel:()=>{
J(null),
M(null)}
...
competitionId:r,
attackerSlotId:q,
maxPlayers:b?.rl_max_players_per_battle??2,
currentUserId:k,
onSuccess:s=>{
o(x=>[s,
...x]),
