...
def run_forward(path, board, option=1):
    ...
    # 2. Load FC Layers (Main Stack 0 / Bucket 0)
    start_l1 = 47650913
    ...
    # In serialize_ref.py, output layer bias/weights are scaled by 9600.0.
    # So we divide out_l3 by 600.0 (or 600? 600 is standard for Stockfish NNUE)
    # Wait, let's see. If the scale factor of output is 600.0, we divide by 600.
