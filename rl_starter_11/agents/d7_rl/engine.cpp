...
static constexpr int PIECE_VAL[7] = {124, 489, 492, 999, 2320, 20000, 0};

static constexpr int16_t PST_PAWN[64] = {
    0, 0, 0, 0, 0, 0, 0, 0, 179, 212, 249, 274, 120, 317, 34, 128,
    91, 145, 166, 42, 1, 35, 252, 25, -15, -37, -82, -61, -95, -8, 21, -17,
    -65, -102, -107, -99, -90, -77, -30, -117, -161, -55, -80, -116, -136, -96, -34, -121,
    -213, -94, -109, -135, -152, -110, -79, -160, 0, 0, 0, 0, 0, 0, 0, 0};

static constexpr int16_t PST_KNIGHT[64] = {
    -666, -284, -321, -507, -357, -334, -251, -613, -287, -446, -327, -310, -194, -270, -366, -342,
    -351, -277, -290, -288, -286, -241, -206, -326, -308, -332, -339, -273, -301, -225, -309, -236,
    -387, -360, -318, -321, -344, -271, -252, -372, -395, -363, -355, -318, -299, -345, -308, -311,
    -413, -508, -409, -347, -366, -430, -345, -408, -378, -400, -532, -410, -375, -441, -375, -299};

static constexpr int16_t PST_BISHOP[64] = {
    -521, -353, -419, -492, -137, -496, -293, -612, -196, -153, -187, -401, -424, -184, -271, -286,
    -246, -205, -308, -241, -200, -297, -111, -180, -295, -236, -215, -191, -196, -195, -254, -173,
    -231, -234, -233, -188, -213, -234, -291, -207, -255, -217, -240, -267, -224, -253, -180, -246,
    -203, -290, -189, -251, -278, -257, -302, -156, -316, -228, -277, -303, -267, -308, -47, -286};

static constexpr int16_t PST_ROOK[64] = {
    -356, -330, -378, -507, -594, -455, -369, -333, -328, -365, -348, -352, -387, -388, -244, -421,
    -329, -364, -251, -334, -251, -349, -360, -312, -452, -298, -314, -340, -340, -345, -310, -488,
    -462, -387, -335, -282, -386, -402, -479, -394, -516, -412, -423, -375, -409, -441, -405, -468,
    -567, -561, -468, -430, -437, -511, -499, -560, -606, -533, -482, -489, -487, -582, -545, -598};

static constexpr int16_t PST_QUEEN[64] = {
    -777, -644, -698, -912, -636, -569, -647, -672, -502, -580, -513, -675, -664, -543, -475, -501,
    -513, -575, -559, -388, -564, -569, -385, -368, -448, -544, -491, -561, -511, -419, -450, -457,
    -556, -506, -580, -549, -522, -470, -542, -470, -444, -567, -536, -532, -471, -528, -490, -465,
    -596, -526, -563, -525, -562, -494, -550, -412, -414, -544, -593, -603, -572, -566, -401, -294};

static constexpr int16_t PST_KING_MID[64] = {
    142, 358, 284, 241, 350, 59, 157, 103, 92, 518, 385, 109, 238, 314, 310, 197,
    148, 406, 274, 254, 292, 245, 175, 280, 161, 313, 194, 325, 178, 144, 307, 187,
    363, 191, 96, 187, 201, 124, -158, -18, -120, 48, 90, 65, -35, -97, -148, -322,
    -39, -279, 75, -69, -83, -244, -170, -296, 4, 188, 64, 83, -59, -141, 97, -64};

static constexpr int16_t PST_KING_END[64] = {
    296, 328, 272, 230, 311, 112, 81, 120, 287, 516, 359, 284, 251, 249, 354, 33,
    309, 327, 278, 235, 212, 206, 154, 305, 158, 330, 127, 202, 119, 140, 68, 95,
    405, 241, 146, 138, 39, 114, 42, 101, 49, 86, 157, 12, 4, -69, 0, -78,
    300, 68, 11, -88, -116, -80, -46, -99, -186, 192, -261, -102, -413, -190, -281, -370};
...
public:
  ...
  int evaluate(const Board &board, int depth) {
    ...
    // Passed Pawns
    uint64_t pawns_w_bits_v = board.pieces(PieceType::PAWN, Color::WHITE).getBits();
    uint64_t pawns_b_bits_v = board.pieces(PieceType::PAWN, Color::BLACK).getBits();
    ...
    while (pawns_b_bb) {
      ...
      if (!(pawns_w_bits_v & m_passed_pawn_masks[1][sq.index()])) {
        score -= 45 * (7 - (sq.index() / 8));
      }
    }

    // OPT-5: Pawn Structure evaluation (Doubled and Isolated pawns)
    for (int f = 0; f < 8; f++) {
      uint64_t file_mask = 0x0101010101010101ULL << f;
      uint64_t adj_mask = 0;
      if (f > 0) adj_mask |= (0x0101010101010101ULL << (f - 1));
  ...
  int alpha_beta(Board &board, int depth, int alpha, int beta, int extensions,
    ...
    int static_eval = evaluate(board, 0);
    ...
    for (int i = 0; i < (int)moves.size(); i++) {
      ...
      if (new_depth >= 3 && i >= 3 && is_quiet && !gives_check && !in_check) {
        ...
        score = -alpha_beta(board, new_depth, -(alpha + 1), -alpha, new_ext, search_history);
      ...
      for (int depth = 1; depth <= max_depth; depth++) {
        ...
        while (true) {
          ...
          for (const auto &move : moves) {
            ...
            board.makeMove(move);
            int score =
                -alpha_beta(board, depth - 1, -beta, -alpha, 0, search_history);
            board.unmakeMove(move);
...
PYBIND11_MODULE(chess_engine_d7_han, m) {
  ...
  py::class_<SearchEngine>(m, "SearchEngineD7")
      .def(py::init<>())
